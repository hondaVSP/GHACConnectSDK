//
//  HCHomeNavigationRecordTableViewCell.h
...
@interface HCHomeNavigationRecordTableViewCellData : NSObject
@property (nonatomic, assign) NSInteger action;
@end

@interface HCHomeNavigationRecordTableViewCell : HCTableViewCell
